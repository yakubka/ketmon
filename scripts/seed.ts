...
const FALLBACK_GYMS = [
  ...
  { name: "문학 댄스스튜디오", lat: 37.4200, lng: 126.6830, pop: 55, area: "문학동" },
  ...
  { name: "연수 수영장", lat: 37.4095, lng: 126.6760, pop: 68, area: "연수동" },
  { name: "청학 요가스튜디오", lat: 37.4070, lng: 126.6740, pop: 52, area: "청학동" },
  { name: "옥련 복싱클럽", lat: 37.4145, lng: 126.6670, pop: 44, area: "옥련동" },
  { name: "동춘 필라테스", lat: 37.4035, lng: 126.6790, pop: 58, area: "동춘동" },
  { name: "선학 크로스핏박스", lat: 37.4060, lng: 126.6880, pop: 38, area: "선학동" },
  { name: "송도 무술도장", lat: 37.3860, lng: 126.6580, pop: 33, area: "송도동" },
  { name: "문학 헬스클럽", lat: 37.4185, lng: 126.6835, pop: 62, area: "문학동" },
  { name: "학익 댄스스튜디오", lat: 37.4330, lng: 126.6720, pop: 40, area: "학익동" },
  { name: "연수 테니스클럽", lat: 37.4130, lng: 126.6810, pop: 46, area: "연수동" },
  { name: "청학 크로스핏", lat: 37.4090, lng: 126.6720, pop: 71, area: "청학동" },
  { name: "옥련 필라테스룸", lat: 37.4115, lng: 126.6640, pop: 50, area: "옥련동" },
